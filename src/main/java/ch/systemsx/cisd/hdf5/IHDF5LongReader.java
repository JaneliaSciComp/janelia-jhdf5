 ...
 * <p>
 * Obtain an object implementing this interface by calling {@link IHDF5Reader#int64()} or {@link IHDF5Reader#uint64()}.
 * <p>
...
public interface IHDF5LongReader
{
     ...
     *         blockSize).
     */
    public long[] readArrayBlock(HDF5DataSet dataSet, int blockSize,
            long blockNumber);
     ...
     * @return The data block read from the data set.
     */
    public long[] readArrayBlockWithOffset(HDF5DataSet dataSet, int blockSize,
            long offset);
     ...
     * @return The data block read from the data set.
     */
    public MDLongArray readMDArraySlice(HDF5DataSet dataSet, long[] boundIndices);
     ...
     * @return The data block read from the data set.
     */
    public MDLongArray readMDArrayBlock(HDF5DataSet dataSet, int[] blockDimensions,
            long[] blockNumber);
     ...
     * @return The data block read from the data set.
     */
    public MDLongArray readMDArrayBlockWithOffset(HDF5DataSet dataSet,
            int[] blockDimensions, long[] offset);
