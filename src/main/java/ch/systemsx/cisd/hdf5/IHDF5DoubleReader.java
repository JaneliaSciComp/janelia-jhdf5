 ...
 * <p>
 * Obtain an object implementing this interface by calling {@link IHDF5Reader#float64()}.
 * <p>
...
public interface IHDF5DoubleReader
{
    ...
    /**
     * Reads part or all of a multi-dimensional <code>double</code> array from the data set
     * <var>objectPath</var>.
     * 
     * @param objectPath The name (including path information) of the data set object in the file.
     ...
     * @return The data block read from the data set.
     */
    public MDDoubleArray readMDArraySlice(HDF5DataSet dataSet, long[] boundIndices);
     ...
     * @return The data block read from the data set.
     */
    public MDDoubleArray readMDArrayBlock(HDF5DataSet dataSet, int[] blockDimensions,
            long[] blockNumber);
     ...
     * @return The data block read from the data set.
     */
    public MDDoubleArray readMDArrayBlockWithOffset(HDF5DataSet dataSet,
            int[] blockDimensions, long[] offset);
