 ...
 * <p>
 * Obtain an object implementing this interface by calling {@link IHDF5Writer#int64()} or {@link IHDF5Writer#uint64()}.
 * <p>
...
public interface IHDF5LongWriter extends IHDF5LongReader
{
    ...
    /**
     * Creates a <code>long</code> array (of rank 1) and opens it for reading and writing.
     * 
     * @param objectPath The name (including path information) of the data set object in the file.
     * @param size When the writer is configured to use extendable data types (see
     *            {@link IHDF5WriterConfigurator#dontUseExtendableDataTypes()}), the initial size
    ...
    /**
     * Creates a <code>long</code> array (of rank 1). When creating many data sets with the same
     * features, this method will be faster than
     ...
     * @param blockNumber The number of the block to write.
     */
    public void writeArrayBlock(HDF5DataSet dataSet, long[] data,
            long blockNumber);
    ...
    /**
     * Creates a multi-dimensional <code>long</code> array and opens it for reading and writing.
     * 
     * @param objectPath The name (including path information) of the data set object in the file.
     * @param dimensions When the writer is configured to use extendable data types (see
     *            {@link IHDF5WriterConfigurator#dontUseExtendableDataTypes()}), the initial dimensions
    ...
    /**
     * Creates a multi-dimensional <code>long</code> array. When creating many data sets with the same
     * features, this method will be faster than
    ...
    /**
     * Creates a multi-dimensional <code>long</code> array template which can be used e.g. in
     * {@link #writeArray(String, long[], HDF5DataSetTemplate)} to create data sets.
     * It is meant to be used when creating many data sets with the same features.
     * <p>
     * <i>The template returned by this method must be closed after work, as otherwise resources of
     ...
     *            the according dimension).
     */
    public void writeMDArrayBlock(HDF5DataSet dataset, MDLongArray data,
            long[] blockNumber);
     ...
     * @param offset The offset in the data set  to start writing to in each dimension.
     */
    public void writeMDArrayBlockWithOffset(HDF5DataSet dataSet, MDLongArray data,
            long[] offset);
