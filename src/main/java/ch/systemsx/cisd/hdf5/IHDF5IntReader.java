 ...
 * <p>
 * Obtain an object implementing this interface by calling {@link IHDF5Reader#int32()} or {@link IHDF5Reader#uint32()}.
 * <p>
...
public interface IHDF5IntReader
{
     ...
     *         blockSize).
     */
    public int[] readArrayBlock(HDF5DataSet dataSet, int blockSize,
            long blockNumber);
     ...
     * @return The data block read from the data set.
     */
    public int[] readArrayBlockWithOffset(HDF5DataSet dataSet, int blockSize,
            long offset);
    ...
    /**
     * Reads part or all of a multi-dimensional <code>int</code> array from the data set
     * <var>objectPath</var>.
     * 
     * @param objectPath The name (including path information) of the data set object in the file.
     ...
     * @return The data block read from the data set.
     */
    public MDIntArray readMDArraySlice(HDF5DataSet dataSet, long[] boundIndices);
     ...
     * @return The data block read from the data set.
     */
    public MDIntArray readMDArrayBlock(HDF5DataSet dataSet, int[] blockDimensions,
            long[] blockNumber);
     ...
     * @return The data block read from the data set.
     */
    public MDIntArray readMDArrayBlockWithOffset(HDF5DataSet dataSet,
            int[] blockDimensions, long[] offset);
